...
public abstract class BasicEngineJob<TT extends DataXHiveWriter> extends BasicHdfsWriterJob<TT> {
    ...
    private INameWithPathGetter dumpTablePath;
...
//        }
    ...
    protected Path createPath() throws IOException {
        ...
        this.dumpTablePath = this.createDumpTablePath(this.dumpTable);
        TT writerPlugin = this.getWriterPlugin();
    ...
    protected abstract INameWithPathGetter createDumpTablePath(EntityName dumpTable);
    ...
    protected String getHdfsSubPath() {
        Objects.requireNonNull(this.dumpTablePath, "dumpTablePath can not be null");
        Objects.requireNonNull(timeFormat, "timeFormat can not be null");
        return this.dumpTablePath.getNameWithPath() + "/" + timeFormat.format(DataxUtils.getDumpTimeStamp());
    }
