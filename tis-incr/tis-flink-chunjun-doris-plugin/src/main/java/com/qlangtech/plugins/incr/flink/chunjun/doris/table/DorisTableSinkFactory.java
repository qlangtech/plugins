 ...
 **/
public class DorisTableSinkFactory implements StreamTableSinkFactory<Tuple2<Boolean, Row>> {
...
//        SinkFunction<RowData> sinkFunction = sinkFunctionResult.getSinkFunction();
        return new DorisStreamTableSink(false, rowDataSinkFunc);
    }


    public static class DorisStreamTableSink implements UpsertStreamTableSink<Row> {

        private final BasicTISSinkFactory.RowDataSinkFunc rowDataSinkFunc;
        // private final TableCols sinkColsMeta;
        ...
        public DorisStreamTableSink(boolean isAppendOnly, BasicTISSinkFactory.RowDataSinkFunc rowDataSinkFunc) {
...
//            }
    ...
    public Map<String, String> requiredContext() {
        ...
        context.put(CONNECTOR_TYPE, TISDorisDynamicTableFactory.IDENTIFIER);
