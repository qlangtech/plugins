 ...
 **/
public class DataXHbase20xsqlWriter extends DataxWriter {
    ...
    @FormField(ordinal = 8, type = FormFieldType.TEXTAREA,advance = true , validate = {Validator.require})
    public String template;

    public static String getDftTemplate() {
        return IOUtils.loadResourceFromClasspath(DataXHbase20xsqlWriter.class, "DataXHbase20xsqlWriter-tpl.json");
    }
