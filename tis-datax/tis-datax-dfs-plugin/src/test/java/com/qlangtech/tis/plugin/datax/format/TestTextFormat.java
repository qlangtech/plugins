 ...
 * @create: 2023-08-09 20:50
 **/
public class TestTextFormat extends BasicFormatTest {
    ...
    public void testCreateWriter() throws Exception {
        ...
        Assert.assertEquals(IOUtils.loadResourceFromClasspath(TestTextFormat.class, "tbl_writer_header_true_delimiter_comma.text"), testWithInsert(txtFormat));
