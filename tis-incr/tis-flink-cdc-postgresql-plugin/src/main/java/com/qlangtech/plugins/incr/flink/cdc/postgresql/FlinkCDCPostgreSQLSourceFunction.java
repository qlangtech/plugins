 ...
 **/
public class FlinkCDCPostgreSQLSourceFunction extends FlinkCDCPGLikeSourceFunction {


    public FlinkCDCPostgreSQLSourceFunction(FlinkCDCPGLikeSourceFactory sourceFactory) {
        super(sourceFactory);
    }
}
