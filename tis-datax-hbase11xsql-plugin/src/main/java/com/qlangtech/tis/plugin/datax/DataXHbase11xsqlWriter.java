 ...
 **/
public class DataXHbase11xsqlWriter extends DataxWriter {
    ...
    public static String getDftTemplate() {
        return IOUtils.loadResourceFromClasspath(DataXHbase11xsqlWriter.class, "DataXHbase11xsqlWriter-tpl.json");
    }
