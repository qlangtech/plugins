 ...
 **/
public class DataXRdbmsReader extends DataxReader {
    private static final String DATAX_NAME = "Rdbms";
    ...
    public static String getDftTemplate() {
        return IOUtils.loadResourceFromClasspath(DataXRdbmsReader.class, "DataXRdbmsReader-tpl.json");
    }
