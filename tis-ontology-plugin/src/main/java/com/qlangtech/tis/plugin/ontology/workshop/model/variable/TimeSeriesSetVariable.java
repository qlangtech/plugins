...
/**
 * {@link VariableType#TIME_SERIES_SET} —— 单个对象某属性的时间序列。
 *
 ...
 */
public class TimeSeriesSetVariable extends WorkshopVariable {

  @Override
  public VariableType getVariableType() {
    return VariableType.TIME_SERIES_SET;
  }
  ...
  public static class DefaultDescriptor extends BasicDescriptor {
    ...
    public DefaultDescriptor() {
      super(VariableType.TIME_SERIES_SET);
    }
  }
}
