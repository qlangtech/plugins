 ...
 **/
public class TestDataXDFSWriterReal {
    ...
    public void testRealDump() throws Exception {
        ...
        final DataXDFSWriter writer = getFTPWriter(ftpServer);
...
//        CreateTableSqlBuilder.CreateDDL ddl = writer.generateCreateDDL(tabMap);
        ...
        ftpServer.useFtpHelper((helper) -> {
            ...
            HashSet<ITDFSSession.Res> importFiles = helper.getListFiles(FTP_PATH + "/*", 0, 100);
    ...
    private DataXDFSWriter getFTPWriter(final FTPServer ftpServer) {
        DataXDFSWriter writer = new DataXDFSWriter();
