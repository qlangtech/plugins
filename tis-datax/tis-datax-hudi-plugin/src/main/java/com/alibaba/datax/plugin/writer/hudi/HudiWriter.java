...
//    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        cfg.sourceClassName = "org.apache.hudi.utilities.sources.JsonKafkaSource";
        cfg.sourceOrderingField = "ts";
        cfg.targetBasePath = "/user/hive/warehouse/stock_ticks_cow";
        cfg.targetTableName = "stock_ticks_cow";
