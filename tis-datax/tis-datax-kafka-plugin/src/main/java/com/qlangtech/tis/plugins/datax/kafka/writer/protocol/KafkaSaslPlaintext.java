...
public class KafkaSaslPlaintext extends KafkaProtocol {
    ...
    protected TISKafkaProtocol getKafkaProtocol() {
        return TISKafkaProtocol.SASL_PLAINTEXT;
    }

    @Override
    protected void addCustomersProps(ImmutableMap.Builder<String, Object> builder) {
