...
//        return Triple.of(execContext, snapshotConsumer, triggerCfg);
    ...
    public static DataxPrePostConsumer createPrePostConsumer() {
        ...
        return new DataxPrePostConsumer(systemPramsSuppiler);
    }
...
//                            LifeCycleHook.Prep), tab.getName());
//
//                    previousTrigger.run();
...
//
//                    reportError(e, execChainContext.getTaskId(), svc);
//
...
//        }
    ...
    public static void executeSplitTabSync(ITaskExecutorContext context, RpcServiceReference statusRpc
        ...
        try {
            ...
            context.errorLog("spilt table sync job:" + tabSync.tskMsg.getJobFileName() + " faild", e);
            reportError(e, execChainContext.getTaskId(), svc);
            // return new ProcessResult(false, e.getMessage());
            throw new RuntimeException("spilt table sync job:" + tabSync.tskMsg.getJobFileName() + " faild", e);
        }
    }
...
//    }
    ...
    public static IRemoteTaskTrigger createDataXJob(AbstractExecContext execContext //
            , Pair<String, LifeCycleHook> lifeCycleHookInfo, String tableName) {
    ...
    public static void reportError(Exception e, Integer taskId, RpcServiceReference svc) {

        Throwable rootCause = ExceptionUtils.getRootCause(e);
        svc.appendLog(LogLevel.ERROR, taskId, Optional.empty(),
