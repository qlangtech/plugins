...
import com.qlangtech.tis.plugins.incr.flink.cdc.AbstractRowDataMapper.BinaryRawValueDTOConvert;
...
public class MongoDBCDCTypeVisitor extends AbstractRowDataMapper.DefaultTypeVisitor {
    ...
    public MongoDBCDCTypeVisitor(IColMetaGetter meta, int colIndex, ZoneId zoneId) {
        super(meta, colIndex);
