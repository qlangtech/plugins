...
/**
 * {@link VariableType#OBJECT_SET_FILTER} —— 对象集合的过滤条件，值由运行时交互（图表刷选 / 过滤组件）写入。
 *
 ...
 */
public class ObjectSetFilterVariable extends WorkshopVariable {

  @Override
  public VariableType getVariableType() {
    return VariableType.OBJECT_SET_FILTER;
  }
  ...
  public static class DefaultDescriptor extends BasicDescriptor {
    ...
    public DefaultDescriptor() {
      super(VariableType.OBJECT_SET_FILTER);
    }
  }
}
