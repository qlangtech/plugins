 ...
 */
public class OntologyObjectType extends Ontology implements MultiStepsSupportHost,
     ...
     * @param sharedProp
     */
    public void setSharedProperty(InferenceParse.TargetProperty targetProperty, OntologySharedProperty sharedProp) {
    ...
    public void setValeType(InferenceParse.TargetProperty targetProperty, OntologyValueType valueType) {
        if (targetProperty == null) {
            throw new IllegalArgumentException("param targetProperty can not be null");
        }
        if (valueType == null) {
