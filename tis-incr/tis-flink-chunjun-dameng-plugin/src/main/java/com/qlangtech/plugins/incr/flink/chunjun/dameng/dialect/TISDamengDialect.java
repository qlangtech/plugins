...
package com.qlangtech.plugins.incr.flink.chunjun.dameng.dialect;
 ...
 **/
@SupportUpdateMode(modes = {WriteMode.INSERT, WriteMode.UPSERT})
public class TISDamengDialect extends DamengDialect {
//    @Override
...
//    }
    ...
    public TISDamengDialect(SyncConf syncConf) {
