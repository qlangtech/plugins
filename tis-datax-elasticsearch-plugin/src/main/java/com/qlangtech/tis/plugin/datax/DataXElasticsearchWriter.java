...
//    public String 默认值: false;
    ...
    public static String getDftTemplate() {
        return IOUtils.loadResourceFromClasspath(DataXElasticsearchWriter.class, "DataXElasticsearchWriter-tpl.json");
    }
...
//        }
//
        throw new RuntimeException("dbName:" + "" + " relevant DS is empty");
    }
