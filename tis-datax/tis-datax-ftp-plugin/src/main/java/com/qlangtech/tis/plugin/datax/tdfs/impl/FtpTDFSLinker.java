...
//    public String path;
    ...
    public ITDFSSession createTdfsSession() {
        FTPServer ftpServer = getFTPServer();
        return ftpServer.createFtpHelper(ftpServer.timeout);
    }
...
//        }
        ...
        protected boolean validateAll(IControlMsgHandler msgHandler, Context context, PostFormVals postFormVals) {
            ...
            return server.useFtpHelper((ftp) -> {
                try {
                    HashSet<String> allFiles = ftp.getAllFiles(Collections.singletonList(ftpLinker.path), 0, 10);
