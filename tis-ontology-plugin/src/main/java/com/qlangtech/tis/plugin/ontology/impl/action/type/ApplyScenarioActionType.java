...
/**
 * Apply Scenario Action Type - 场景合并操作
 * <p>
 * 对应 APPLY_SCENARIO 规则：将场景中的编辑合并到主 Ontology
 * <p>
 * TODO: 待实现 ApplyScenarioRule 后，添加 @FormField 字段引用
 *
 * @author 百岁 (baisui@qlangtech.com)
 * @date 2026/9/7
 */
public class ApplyScenarioActionType extends ActionType {
    ...
    public List<RuleType> getAllowedRuleTypes() {
        return List.of(RuleType.APPLY_SCENARIO);
    }

    @Override
    public OntologyActionRule getRule() {
        // TODO: 待实现 ApplyScenarioRule 后返回具体规则
        return null;
    }
