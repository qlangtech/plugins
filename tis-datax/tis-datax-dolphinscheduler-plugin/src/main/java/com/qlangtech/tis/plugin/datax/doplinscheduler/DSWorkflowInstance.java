 ...
 **/
public class DSWorkflowInstance extends BasicWorkflowInstance {
    private final ExportTISPipelineToDolphinscheduler exportCfg;

    public DSWorkflowInstance(ExportTISPipelineToDolphinscheduler exportCfg
    ...
    public List<IWorkflowNode> getWorkflowNodes() {
        return DSWorkflowPayload.getDAGNodes(this.exportCfg, this);
    }
}
