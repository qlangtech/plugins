...
import com.dtstack.chunjun.connector.dameng.source.DamengSourceFactory;
 ...
 **/
public class DamengSourceFunction extends ChunjunSourceFunction {

    public DamengSourceFunction(ChunjunSourceFactory sourceFactory) {
        super(sourceFactory);
    }
...
//    }
    ...
    private static class ExtendOracleSourceFactory extends DamengSourceFactory {
        ...
        public ExtendOracleSourceFactory(SyncConf syncConf, DataSourceFactory dataSourceFactory, List<IColMetaGetter> sourceColsMeta) {
            ...
            super(syncConf, null, new TISDamengDialect(syncConf), sourceColsMeta);
        ...
        protected JdbcInputFormatBuilder getBuilder() {
            return new JdbcInputFormatBuilder(new TISDamengInputFormat(dataSourceFactory, this.sourceColsMeta));
        }
    }
}
