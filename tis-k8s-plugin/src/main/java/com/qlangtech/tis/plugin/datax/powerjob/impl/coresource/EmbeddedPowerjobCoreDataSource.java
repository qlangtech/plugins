...
public class EmbeddedPowerjobCoreDataSource extends PowerjobCoreDataSource {
    ...
    public String createCoreJdbcUrl() {
        return "jdbc:mysql://" + K8SUtils.K8S_DATAX_POWERJOB_MYSQL_SERVICE.getHostPortReplacement() + "/powerjob-daily?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai";
    }

    @Override
    public RcDeployment getRCDeployment(K8SController k8SController) {
        return k8SController.getRCDeployment(K8SUtils.K8S_DATAX_POWERJOB_MYSQL);
    }

    @Override
    public void launchMetaStoreService(K8SDataXPowerJobServer powerJobServer) throws ApiException, PowerjobOrchestrateException {
        ...
        try {
            ...
            sse.writeComplete(K8SUtils.K8S_DATAX_POWERJOB_MYSQL, success);
        }

        K8SUtils.createService(v1Api, powerjobMySQLImage.namespace //
                , K8SUtils.K8S_DATAX_POWERJOB_MYSQL_SERVICE, K8S_DATAX_POWERJOB_MYSQL, mysqlPort3306, mysql3306);
    }
