 ...
 **/
public class TestBuildHistoryPayloadFactory implements WorkFlowBuildHistoryPayloadFactory {
    @Override
    public WorkFlowBuildHistoryPayload create(IDataxProcessor dataxProcessor, Integer tisTaskId, ICommonDAOContext daoContext) {
        return new TestBuildHistoryPayload(dataxProcessor, tisTaskId, daoContext);
    }
}
