 ...
 **/
public class TestDataXDFSWriter {
    @Test
    public void testGetDftTemplate() {
        String dftTemplate = DataXDFSWriter.getDftTemplate();
    ...
    public void testDescGenerate() {
        PluginDesc.testDescGenerate(DataXDFSWriter.class, "ftp-datax-writer-descriptor.json");
    }
    ...
    public void testTempateGenerate() throws Exception {
        ...
        DataXDFSWriter dataXWriter = new DataXDFSWriter();
        dataXWriter.template = DataXDFSWriter.getDftTemplate();
