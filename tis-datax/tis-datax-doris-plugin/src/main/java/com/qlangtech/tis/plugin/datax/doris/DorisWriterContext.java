 ...
 **/
public class DorisWriterContext extends RdbmsWriterContext<BasicDorisWriter, DorisSourceFactory> {

    public DorisWriterContext(BasicDorisWriter writer, IDataxProcessor.TableMap tabMapper) {
